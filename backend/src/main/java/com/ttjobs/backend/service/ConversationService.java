...
public class ConversationService {
    ...
    public ConversationDTO createConversation(CreateConversationRequest request) {
        ...
        return toDto(savedConversation, members.stream().map(User::getId).toList());
    }
    ...
    public List<ConversationDTO> getMyConversations() {
        ...
        return conversations.stream()
                .map(conversation -> toDto(conversation, memberMap.getOrDefault(conversation.getId(), List.of())))
    ...
    private ConversationDTO toDto(Conversation conversation, List<Long> memberIds) {
